...
export const CoinCard = ({coin, cost}) => {
    return (
        <div className="bg-white overflow-hidden shadow rounded-lg border-purple-800 border-solid border-4 cursor-pointer">
            <div className="px-4 py-5 sm:p-6 text-center">
                <dt className="text-sm font-medium text-gray-500 truncate">{coin}</dt>
                <dd className="mt-1 text-3xl font-semibold text-gray-900">{cost}</dd>
            </div>
